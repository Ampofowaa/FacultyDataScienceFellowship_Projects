...
*Attribute 1	
forv i = 1/4 {
	la var A`i'_1 " Walking distance from the original destination station D"
}
forv l = 0(5)20 {
...
texdoc init carsharing_DCE.txt, replace
tex [[AdvancedFormat]]
...
forv n = 1/`=_N' { // = foreach line in the dataset
	...
	*Question to be asked to the respondent
	tex Suppose you originally request a car from station O to station D and other destination stations with different discounts are made available to you, which one do you prefer? </br >
