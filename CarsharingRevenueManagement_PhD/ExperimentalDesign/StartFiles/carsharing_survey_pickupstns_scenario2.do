...
#d ;
import excel using altpickupstns_newdce.xlsx, clear 
	sheet(Sheet1) 
	cellrange(A1:H21)
	first
;
...
texdoc init altpickupstns_scenario2_questions_v1.txt, replace
tex [[AdvancedFormat]]
...
forv n = 1/`=_N' { // = foreach line in the dataset
	...
	*Column headers
	...
	tex <td `headcolstyle'><strong>Option 1 (No purchase)</strong></td>
