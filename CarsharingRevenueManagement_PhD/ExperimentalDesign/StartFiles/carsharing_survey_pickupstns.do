...
#d ;
import excel using 6blocks_design_pickup_stns.xlsx, clear 
	sheet(Sheet1) 
	cellrange(A1:H25)
	first
;
...
*Attribute 1
forv i = 1/3 {
	la var A`i'_1 " Walking distance from the original pick-up station O"
}
forv l = 0(5)20 {
...
texdoc init altpickupstns_survey_questions.txt, replace
tex [[AdvancedFormat]]
...
forv n = 1/`=_N' { // = foreach line in the dataset
	...
	*Column headers
	...
	tex <td `headcolstyle'><strong>Option 1 (Original Booking)</strong></td>
